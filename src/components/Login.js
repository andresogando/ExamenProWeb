  ...
  render() {
    return (
      ...
      <div class="form-group">
       ...
       <small id="emailHelp" class="form-text text-muted">Ejemplo: Andres@gmail.com</small>
      </div>
       <div class="form-group">
      ...
      <small id="emailHelp" class="form-text text-muted">Ejemplo: Clave de mas de 6 Caracteres. (Prueba11)</small>
